...
## bash bash_model_A_bootstrap.sh

## Note: Depending on operation system, script might need to be converted to unix using dos2unix scripts/bash_model_A_bootstrap.sh
## and dos2unix scripts/bash_model_A_run.sh
...
sbatch -a 1-101 bash_model_A_run.sh
