...
## Only the objects that are called in the script 13_model_B_run_bootstrap_stability.R
...
Rscript scripts/13_model_B_run_bootstrap_stability.R $SLURM_ARRAY_TASK_ID 
