...
# Date: 2024-08-15
#
# Script Name: 06a_longitudinal_features_no_LGM.R
#
...
# RMSSD, those will later be appended to the variable set for training the 
# ML models
#
#
# Notes: Since no models are calculated here, this step takes place with the 
# full sample (training + test set)
#
#
...
## loading in full cleaned dataset (CBLC + IDs + covariates, no PGS)
...
## those were created in the script 02_data_exploration_compressed.R
...
## Calculating longitudinal variables
...
## in script 06_b_autocorrelation.R)
