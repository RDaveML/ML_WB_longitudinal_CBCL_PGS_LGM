...
# Date: 2024-12-03
#
# Script Name: 06c_merge_nonLGM.R
#
...
# scripts 06a_longitudinal_features_no_LGM.R and 06b_autocorrelation.R
# Necessary covariates will be retained and the complete feature set which
# will be used in the baseline models 
## (model A, no LGM features, no Polygenic scores)
# will be saved
#
#
# Notes:
...
## Binding together all dfs (note: this is then dataframe for model D!
## Only there longitudinal features are first included)
...
saveRDS(
  data_model_D_1, here::here("data", "intermediate", "data_model_D_1.rds"))
cat("data were saved in file: ", filename)
