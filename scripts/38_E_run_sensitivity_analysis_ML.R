...
#
#
# Notes: 38_E_run_sensitivity_analysis_ML.R runs model C
...
num_covariates <- c(
  ...
  grep("[0-9]+_1KG", colnames(data_model_E), value = TRUE)
)
...
cat("duration entire script (model E, custom functions): ",
