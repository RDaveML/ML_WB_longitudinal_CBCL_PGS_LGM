...
# Date: 2025-08-26
#
# Script Name: 25_stacked_ensemble_model_E.R
#
# Script Description: This script codes the stacked ensemble model 
# for variable set E (CBCL items + longitudinal variables + PGS + covariates)
...
## 1) Loading in original train test split (set E contains PGS data)
train_ids <- readRDS(
