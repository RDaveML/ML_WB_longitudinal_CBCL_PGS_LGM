...
# model B after removing the top 5% multivariate outliers to 
# see if results are robust. No stsability assessment will take place
#
#
# Notes: 35_B_run_sensitivity_analysis_ML.R runs model B
# (only PGS + covariates)
#
#
...
cat("duration entire script (model B, custom functions): ",
