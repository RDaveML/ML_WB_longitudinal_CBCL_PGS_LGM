...
# Date: 2025-06-25
#
# Script Name: 20_stacked_ensemble_model_C.R
#
...
## note: no stacked xgb model trained as it performed worse than other models 
## in feature set A, therefore dropped to save computational resources
...
model_rf <- readRDS(
  here::here("data", "intermediate", "bootstrap",
             "workspace_model_C_iteration_1.rds"))$run_rf$model_bayes_rf 

model_xgb <- readRDS(
  here::here("data", "intermediate", "bootstrap",
             "workspace_model_C_iteration_1.rds"))$run_xgb$model_bayes_xgb
...
boot_metrics_C <- readRDS(here::here("data", "intermediate", "bootstrap", 
                                     "boot_results_performace_C.rds"))
