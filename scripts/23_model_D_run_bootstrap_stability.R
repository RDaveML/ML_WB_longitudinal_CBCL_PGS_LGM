...
if(data_prepared == FALSE){
  ...
  for (iter in iterations) {
    ...
    ## first test on monday, 14th july: Function works but time estimate is
    ## worthless because only 2 / 80 CBCL LGM feature sets included
    ## CONTINUE HERE with full LGM dataset! Run script 22 before
