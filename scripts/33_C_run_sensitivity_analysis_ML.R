...
# Date: 2025-09-30
#
# Script Name: 33_C_run_sensitivity_analysis_ML.R
#
# Script Description: This script is supposed to re-run the ML training part for 
# variable set C after removing the top 5% multivariate outliers to 
# see if results are robust. No stability assessment will take place,
# thus, no bootstrapping, models are only trained once
#
#
# Notes: 33_C_run_sensitivity_analysis_ML.R re-runs the analysis
# for variable set C (raw CBCL scores + PGS + covariates)
#
#
...
cat("duration entire script variable set C, sensitivity analysis: ",
