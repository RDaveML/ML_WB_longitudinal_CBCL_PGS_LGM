...
# Date: 2025-10-06
#
# Script Name: 41_C_sensitivity_stacked_ensemble_model_performance.R
#
# Script Description: Re-calculating stacked ensemble model 
# and model performance metrics for variable set C 
# (CBCL items + PGS + covariates) after removing 5% MCD outliers
...
workspace <- readRDS(
  paste0(filepath, "/", "sensitivity_workspace_model_C_iteration_1.rds"))
...
filename <- "boot_results_performace_C_sensitivity.rds"
