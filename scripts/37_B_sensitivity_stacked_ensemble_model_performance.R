...
# Date: 2025-10-06
#
# Script Name: 40_B_sensitivity_stacked_ensemble_model_performance.R
#
# Script Description: Re-calculating stacked ensemble model 
# and model performance metrics for variable set B (PGS + covariates)
## after removing 5% MCD outliers
...
workspace <- readRDS(
  paste0(filepath, "/", "sensitivity_workspace_model_B_iteration_1.rds"))
...
filename <- "boot_results_performace_B_sensitivity.rds"
